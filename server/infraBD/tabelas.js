class Tabelas {
    ...
    CkeckTabelaCarros() {
        ...
        const queryTabelainformacoes = "CREATE TABLE IF NOT EXISTS  informacoes(id int NOT NULL AUTO_INCREMENT, whatsapp varchar(100), facebook varchar(100), youtube varchar(100), instagram varchar(100), email varchar(100), lojaUm varchar(100), horarioFuncionamentoUm varchar(100), logradouroUm varchar(100), bairroCidadeUm varchar(100), cepUm varchar(100), telefoneUm varchar(100), lojaDois varchar(100), horarioFuncionamentoDois varchar(100), logradouroDois varchar(100), bairroCidadeDois varchar(100), cepDois varchar(100), telefoneDois varchar(100), lojaTres varchar(100), horarioFuncionamentoTres varchar(100), logradouroTres varchar(100), bairroCidadeTres varchar(100), cepTres varchar(100), telefoneTres varchar(100), lojaQuatro varchar(100), horarioFuncionamentoQuatro varchar(100), logradouroQuatro varchar(100), bairroCidadeQuatro varchar(100), cepQuatro varchar(100), telefoneQuatro varchar(100), sobreNos varchar(500), imagensSlide varchar(800), PRIMARY KEY(ID) )"
        const queryTabelaUser = "CREATE TABLE IF NOT EXISTS user(id int NOT NULL AUTO_INCREMENT, primeiroNome varchar(45) NOT NULL, ultimoNome varchar(45) NOT NULL, email varchar(45) NOT NULL, password varchar(45) NOT NULL, codeUser varchar(500), PRIMARY KEY(ID))"
        ...
        this.conexao.query(queryTabelaUser, (erro) => {

            if (erro) {
                console.log(erro)
            } else {
                console.log("Tabela ===> USER <===  criada/ja existe com sucesso.")
            }
