class Tabelas {
    ...
    CkeckTabelaCarros() {
        ...
        const queryTabelaUser = "CREATE TABLE IF NOT EXISTS user(id int NOT NULL AUTO_INCREMENT, primeiroNome varchar(45) NOT NULL, ultimoNome varchar(45) NOT NULL, email varchar(45) NOT NULL, password varchar(45) NOT NULL, token varchar(500), PRIMARY KEY(ID))"
